...
var PythonHighlightRules = function () {
    var keywords = ("nhi|ya|warna|warna agar|" +
        "|aur|agar|" +
        "raise|return|try|while|with|yield|async|ya|await|nonlocal");
    var builtinConstants = ("True|False|sahi|ghalat|Ellipsis|__debug__");
    var builtinFunctions = ("|input|btao|print|likho|jabtak|" +
