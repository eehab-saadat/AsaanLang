from transpiler.modules.models.tokens import OPERATOR, BOOL_KW, CONDITIONAL_EXP, COMMENT, KEYWORD
from transpiler.modules.models.types import NUMBER, ISHARIYA, LAFZ, BOOLEAN
